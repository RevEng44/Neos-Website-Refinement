  ...
  return (
    ...
    >
      ...
      <motion.div style={{ opacity, y }} className="absolute inset-0 z-0">
        ...
        >
          <defs>
            <pattern id="gridFine2" x="0" y="0" width="48" height="48" patternUnits="userSpaceOnUse">
              <path d="M 48 0 L 0 0 0 48" fill="none" stroke="rgba(201,169,98,0.035)" strokeWidth="0.4" />
            </pattern>
          </defs>
        ...
        >
          ...
          {/* Coordinate dashed reference lines */}
          <g stroke="rgba(201,169,98,0.12)" strokeWidth="0.4" strokeDasharray="3 4" fill="none">
            <line x1="0" y1="120" x2="820" y2="120" />
            <line x1="820" y1="120" x2="820" y2="540" />
            <line x1="0" y1="210" x2="1420" y2="210" />
            <line x1="1420" y1="0" x2="1420" y2="210" />
            <line x1="0" y1="430" x2="1120" y2="430" />
            <line x1="1120" y1="0" x2="1120" y2="430" />
          </g>
      ...
      <div className="relative z-20 max-w-[1400px] mx-auto px-6 md:px-12 w-full pt-28 md:pt-20">
        <div className="max-w-5xl">
          ...
          >
            <span className="text-gold tracking-[0.3em] text-[10px] md:text-xs font-semibold uppercase">Neos Advisors</span>
